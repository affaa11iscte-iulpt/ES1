...
public class Interface extends JFrame {
	 ...
	 * o painel para carregar os ficheiros, o painel onde � desenhada a tabela
	...
	/**
	 * 
	 * Esta funcao cria um painel, onde � desenhada uma tabela do tipo DefaulTableModel,
	 *  com 2 colunas (Regras e Pesos) e com a jun��o de uma scroll area. 
	 * S�o criados sub Paineis, o primeiro tem o modo automatico e o manual onde neste e permitido editar uma coluna
