...
public class Interface extends JFrame {
	...
	/**
	 * Cria��o do painel onde carrega os ficheiros escolhidos
	 * return @JPanel
	 */
	...
	/**
	 * Cria��o do painel onde especifica a tabela e trata o modo, isto �, autom�tico e manual 
	 * return @JPanel
	 */
	...
	/**
	 * Cria��o do painel onde mostra os falsos positivos/negativos gerados e as op��es de guardar e apagar as configura��es
	 * return @JPanel
	 */
	private JPanel modePanel(){
		...
		JButton guardar = new JButton ("Guardar Configura��o");
	...
	/**
	 * Altera o valor das labels dos falsos positivos quando este � calculado, recebe um inteiro (numero de falsos positivos), que vai ser o valor a adicionar na label 
	 * @param i
	 */
	...
	/**
	 * Altera o valor das labels dos falsos negativos quando este � calculado, recebe um inteiro (numero de falsos negativos), que vai ser o valor a adicionar na label 
	 * @param i
	 */
	...
	/**
	 * Obten��o do HashMap de regras (com pesos associados) lidas na classe Reader
	 */
	...
	/**
	 * Devolve as regras e os respetivos pesos num HashMap, sendo que a chave � a regra
	 * e o valor o peso.
